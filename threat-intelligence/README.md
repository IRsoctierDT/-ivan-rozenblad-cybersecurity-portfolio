...
**Status:** ✅ Active — first artifacts shipped inside [IANUA](../projects/ianua.md).
...
- **[Threat Intelligence Agent — case study](https://github.com/IRsoctierDT/IANUA/blob/main/docs/case-studies/threat-intel-agent.md)** —
...
- **[MITRE ATT&CK Mapper Agent — case study](https://github.com/IRsoctierDT/IANUA/blob/main/docs/case-studies/mitre-mapper-agent.md)** —
  deterministic event → tactic/technique mapping with confidence scoring and evidence.
- **Sigma correlation rules** — detection-matcher findings in IANUA now cross-reference
  Sigma correlation rules, closing the loop from intel to detection content.
